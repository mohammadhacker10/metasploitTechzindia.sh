...
echo "##############################################"
echo " Emrozyha_iran, PLZ SUBSCRIBE Emrozyha Telegram CHANNEL"
echo "##############################################"
...
figlet TechZindia
echo "###############################################"
echo "Hello Guys,  Subscribe  My Emrozyha Telegram channel"
figlet Subscribe
echo "###############################################"
echo "###############################"
echo "For More Hacking video At Emrozyha Telegram Channel"
echo "###############################"
figlet Emrozyha_iranian
echo "####################################"
